    ...
    with get_db() as conn:
        try:
            asset = asset_service.create_asset(
                ...
                gics_sector=body.gics_sector,
                gics_industry_group=body.gics_industry_group,
                gics_industry=body.gics_industry,
                gics_sub_industry=body.gics_sub_industry,
                reit_type=body.reit_type,
                treasury_indexer=body.treasury_indexer,
